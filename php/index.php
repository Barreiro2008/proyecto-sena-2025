...
<body class="jm-body">
    <div class="jm-sidebar">
        ...
        <ul class="jm-menu">
            ...
            <li><a href="php/gestion/datos_personales.php" class="jm-link"><i class="fas fa-user mr-2"></i> Datos personales</a></li>
            ...
            <li><a href="php/gestion/listar_ventas.php" class="jm-link"><i class="fas fa-chart-line mr-2"></i> Listar Ventas</a></li>
            ...
            <?php if (isset($_SESSION['rol']) && $_SESSION['rol'] === 'admin'): ?>
                <li><a href="php/gestion/gestion_producto.php" class="jm-link"><i class="fas fa-box-open mr-2"></i> Gestión producto</a></li>
            <?php endif; ?>
            <li><a href="php/gestion/gestion_lote.php" class="jm-link"><i class="fas fa-cubes mr-2"></i> Gestión lote</a></li>
            ...
            <?php if (isset($_SESSION['rol']) && $_SESSION['rol'] === 'admin'): ?>
                <li><a href="php/gestion/gestion_proveedor.php" class="jm-link"><i class="fas fa-truck mr-2"></i> Gestión proveedor</a></li>
            <?php endif; ?>
        </ul>
    </div>
    ...
    <div class="jm-main">
        ...
        <div class="jm-accesos-rapidos">
            ...
            <div class="jm-acciones-grid">
                    <a href="php/gestion/gestion_producto.php" class="jm-accion-card">
                ...
                <a href="php/gestion/gestion_lote.php" class="jm-accion-card">
                ...
                <a href="php/gestion/listar_ventas.php" class="jm-accion-card">
                ...
                <?php if (isset($_SESSION['rol']) && $_SESSION['rol'] === 'admin'): ?>
                    <a href="php/gestion/gestion_proveedor.php" class="jm-accion-card">
                    ...
                    <a href="php/gestion/gestion_usuario.php" class="jm-accion-card">
                ...
                <?php endif; ?>
                <a href="php/gestion/datos_personales.php" class="jm-accion-card">
        ...
        <footer class="jm-footer">
            &copy; 2025 Variedades Juanmarc. Todos los derechos reservados.
        </footer>
    </div>
